const portfolio = [
    ...
    {
        title: "API Sistema Control Stock",
        description: "API de prueba con datos para un sistema de control de stock. Se puede consumir normalmente salvo hacer operaciones de inserción o modificación de datos.",
